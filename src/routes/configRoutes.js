...
export const routesInit = (app) => {
    ...
    app.get("/getRestaurantById/:id", adminRestaurantsController.getRestaurantById);
    app.get("/adminGetRestaurantsMenu/:id", adminRestaurantsController.adminGetRestaurantsMenu);
